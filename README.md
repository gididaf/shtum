...
Referring to "shtum" descriptively — "compatible with shtum", "a shtum alternative", "inspired by shtum" — is fine and explicitly allowed.

If you'd like to use the name in a way not covered above, or to discuss a licensing arrangement, open an issue or get in touch.
